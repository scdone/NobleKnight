...
const firstEvent = [
    {
        id: 0,
        eventName: `welcome`,
        eventText: `Huzzah, Noble ${playerName}}! Welcome to ye kingdom!  
...

    {
        ...
        choices: {
            firstChoice: {
                ...
                choiceText: `HUZZAH, NOBLE ${playerName}! You take the sword without waking the dragon. You return to the kingdom and give the Almighty Claymore of Justice to King Bloodworthe. Impressed with your bravery, he gives you his blessing to marry Princess Wren. She swoons over your strength and skill. QUEST COMPLETED!`,
                gameOver: false,
                changeScore: 80
            },
            secondChoice: {
