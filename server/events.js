...
const firstEvent = [
    {
        ...
        eventName: `welcome`,
        eventText: `  
        For seven years ye have pined for the beautiful Princess Wren's hand in marriage. Her father, King Bloodworth III, has sent you on a quest to bring back the Ancient Claymore of Justice hidden in the Monstrous Caverns past the depths of the Deadhaze forest. Danger and Mystery abound...
...
const lastEvents = [
...

    {
        id: 8,
        eventName: `sword`,
        eventText: `As your eyes adjust to the darkness, you see a mighty dragon sleeping in the back of the cave. Near his enormous snout, you see a glowing rock with a sword stuck in the top. You recognize the sword as the Almighty Claymore of Justice. 
